                                ...
                                <ul class="nav-items mb-0">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48"
                                                     src="{{asset('media/avatars/avatar1.jpg')}}" alt="">
                                                <span
                                                            ...
                                                            <li class="nav-main-item">
                                                                ...
                                                                <ul class="nav-main-submenu">
                                                                    <li class="nav-main-item">
                                                                        <a class="nav-main-link" href="#">
                                                                            <span
                                                                                class="nav-main-link-name">Link 6-1</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-main-item">
                                                                        <a class="nav-main-link" href="#">
                                                                            <span
                                                                                class="nav-main-link-name">Link 6-2</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                    ...
                    <!-- Course -->
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <a class="block block-rounded block-link-pop" href="">
                                <div class="block-content block-content-full text-center" style="background-color: {!! $routines[$i]->getColor() !!}">
