    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
                            ...
                            <li class="nav-main-item open">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item open">
                                        ...
                                        <ul class="nav-main-submenu">
                                            <li class="nav-main-item">
                                                <a class="nav-main-link active" href="be_pages_elearning_courses.html">
            ...
            <main id="main-container">
                ...
                <div class="content content-boxed">
                    <div class="row row-deck py-4">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <a class="block block-rounded block-link-pop" href="be_pages_elearning_course.html">
                ...
                <!-- Instructors -->
                <div class="bg-image" style="background-image: url({{'media/photos/photo27@2x.jpg'}});">
                        ...
                        <div class="content content-full content-boxed text-center">
                            ...
                            <div class="row items-push mt-5">
                                <div class="col-md-4 invisible" data-toggle="appear" data-offset="-150" data-timeout="150" data-class="animated fadeInRight">
                                    ...
                                    <div class="font-size-lg text-white mt-3">Marie Duncan</div>
                                ...
                                <div class="col-md-4 invisible" data-toggle="appear" data-offset="-150" data-class="animated zoomIn">
                                    <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/avatar9.jpg')}}" alt="">
                                    <div class="font-size-lg text-white mt-3">Jack Greene</div>
                                ...
                                <div class="col-md-4 invisible" data-toggle="appear" data-offset="-150" data-timeout="150" data-class="animated fadeInLeft">
                                    ...
                                    <div class="font-size-lg text-white mt-3">Danielle Jones</div>
